...
pub struct PublishWorkflowArgs {
    ...
    /// Should be a reference to the package detail generated by the check workspace
...
impl PublishWorkflowArgs {
    pub fn merge(self, other: PublishWorkflowArgs) -> Self {
        Self {
            ...
            package_detail: self.package_detail.or(other.package_detail),
        }
    }
}
    ...
    fn from(value: IndexMap<String, Value>) -> Self {
        ...
        for (k, v) in value {
            match k.as_str() {
                ...
                "package_detail" => me.package_detail = parse_string(v),
                _ => {}
            }
        }
        me
...
impl From<PublishWorkflowArgs> for IndexMap<String, Value> {
    fn from(val: PublishWorkflowArgs) -> Self {
        ...
        if let Some(package_detail) = val.package_detail {
            map.insert("package_detail".to_string(), package_detail.into());
        }
        map
    }
}
